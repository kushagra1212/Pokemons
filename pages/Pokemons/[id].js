...
const PokemonPage = ({ pokemon }) => {
  ...
  return (
    <div className="flex flex-col mt-10 justify-around items-center h-screen">
      <div className="flex flex-wrap justify-start   my-8 ">
        ...
        <div className="w-56 md:w-96 bg-white font-bold mt-10 ml-28 shadow-lg rounded-lg self-stretch transition duration-500 ease-in-out  hover:bg-gray-400 transform hover:-translate-y-1 hover:scale-110   hover:text-gray-900">
          <div
            ...
            className="py-2 text-center font-extrabold md:text-4xl  hover:text-red-50 uppercase tracking-wide text-gray-800"
          >
      ...
      <Link href="/">
        <a className="w-24 text-center h-10 bg-blue-500 text-white rounded text-2xl font-bold overflow-visible justify-start transition duration-500 ease-in-out  hover:bg-red-700 transform hover:-translate-y-1 hover:scale-110 cursor-pointer  hover:text-red-200">
          Home
        </a>
      </Link>
